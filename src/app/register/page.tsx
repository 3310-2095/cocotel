...
const RegisterPage = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('https://www.cocotel.com/frontend/images/upload/banner/Beach1.jpg')",
      }}
    >
      {/* Overlay */}
      ...
      <div className="bg-white rounded-xl shadow-2xl p-4 sm:p-6 md:p-8 w-full max-w-[736px] mt-6 sm:mt-[30px] relative z-10">
        <h2 className="text-xl sm:text-2xl font-semibold mb-4">Register</h2>
...
/>
            ...
            <div className="w-full sm:w-1/2">
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                >
                  {selectedCountryName} ({selectedCountry}) <FiChevronDown className="ml-1" />
                </button>
                {showDropdown && (
