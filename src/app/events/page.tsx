...
const Page = () => {
  ...
  return (
    <section>
      {/* Hero Section */}
      <div
        className="relative bg-cover bg-center bg-no-repeat text-white w-full min-h-[80vh] sm:min-h-[70vh] lg:min-h-[60vh] mx-auto px-4 sm:px-6 lg:px-8"
        style={{
      ...
      >
        <div className="relative mx-auto py-10 sm:py-16 text-center">
          ...
          <p className="text-[16px] mt-2 sm:mt-6 max-w-2xl mx-auto leading-relaxed">
            Your special moments deserve the best. At Cocotel, we offer stunning venues...
          </p>
      ...
      {/* Events Section */}
      <div className="max-w-[80rem] mx-auto px-[18px] sm:px-6 lg:px-8">

        <h1 className="text-[32px] sm:text-[38px] font-semibold text-center md:text-left mt-10 text-[#212529]">
          Event
        </h1>
        ...
        {events.map((event, index) => (
          <div
            key={event.id}
            className="flex flex-col md:flex-row bg-white rounded-lg shadow-lg overflow-hidden mt-4"
          >
            {/* Image Section */}
            <div className="relative w-full md:w-1/2 min-h-[300px] sm:min-h-[400px] md:min-h-[510px]">
              <Image
            ...
            {/* Text Section */}
            <div className="w-full md:w-1/2 bg-green-50 p-6 sm:p-12 flex flex-col justify-between">
              <div>
                <h3 className="text-gray-600 text-lg sm:text-xl tracking-wide text-center md:text-left">
                  {event.event_type}
                </h3>
                <h2 className="text-gray-900 text-2xl sm:text-4xl mt-4 font-semibold text-center md:text-left">
                  {event.event_name}
                </h2>
                <p className="text-black text-base mt-4 sm:mt-6 leading-relaxed">
                  {event.description}
                </p>
                ...
                <div className="flex justify-center sm:justify-start mt-6 sm:mt-8">
                  ...
                  >
                    <button className="bg-[#4CAA42] hover:bg-[#157347] text-white px-6 py-3 rounded text-base w-full sm:w-auto">
                      See more
                    </button>
                  </Link>
                </div>
